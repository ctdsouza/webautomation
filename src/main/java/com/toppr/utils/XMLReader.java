...
public class XMLReader
{
     ...
     */
    protected static HashMap<String, String> getDOMElements(String fileName, String elementName)
    {
        ...
        try
        {
            ...
            Document document = builder.parse(new File("src/main/java/com/toppr/web/" + fileName));
     ...
     */
    public static HashMap<String, String> getTestData(String testDataFile)
    {
        ...
        try
        {
            DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
            DocumentBuilder builder = factory.newDocumentBuilder();
            Document document = builder.parse(new File("src/test/java/com/toppr/web/" + testDataFile));
